...
# HTML 파일 경로
input_file = "/Users/minseon/2025/학부연구생/RAG/RagWithChatbot/input_ask.txt"
output_file = "/Users/minseon/2025/학부연구생/RAG/RagWithChatbot/output_ask.json"  # 변환된 JSON 데이터를 저장할 파일
